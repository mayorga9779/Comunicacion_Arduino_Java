 ...
 */
package com.edgarmayorga.transmitirTX;
 ...
 * @author ZReti
 */
public class TransmitirDatos extends javax.swing.JFrame {
    ...
    /**
     * Creates new form TransmitirDatos
     */
    public TransmitirDatos() {
        initComponents();
        this.setSize(400, 200);
        
        try {
            //para transmitir informacion a Arduino
            comunicacionSerial.arduinoTX("COM4", 9600);             
        } catch (ArduinoException ex) {
            Logger.getLogger(TransmitirDatos.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TransmitirDatos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TransmitirDatos().setVisible(true);
            }
        });
    }
