 ...
 * @author ZReti
 */
public class RecibirTransmitirRXTX extends javax.swing.JFrame {
    private PanamaHitek_Arduino comunicacionSerial = new PanamaHitek_Arduino();
    ...
    /**
     * Creates new form RecibirTransmitirRXTX
     */
    public RecibirTransmitirRXTX() {
        initComponents();
        this.setSize(400, 150);
        try {
            comunicacionSerial.arduinoRXTX("COM4", 9600, listener);
        } catch (ArduinoException ex) {
            Logger.getLogger(RecibirTransmitirRXTX.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void initComponents() {
        ...
        btnOff.setBounds(190, 10, 140, 60);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RecibirTransmitirRXTX.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RecibirTransmitirRXTX().setVisible(true);
            }
        });
    }
